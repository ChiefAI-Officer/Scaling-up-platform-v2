    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center p-6">
            <div className="max-w-3xl w-full text-center">
                ...
                {/* Details Card */}
                <div className="bg-card/5 border border-white/10 rounded-2xl p-8 mb-8 backdrop-blur-sm">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Button variant="outline" size="lg" className="w-full sm:w-auto px-8 gap-2 border-white/20 hover:bg-card/10 hover:text-white">
