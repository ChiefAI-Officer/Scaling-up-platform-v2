...
export function DuoLandingPage({ data }: { data: LandingPageData }) {
    ...
    return (
        <div className="min-h-screen bg-card">
            {/* Hero Section */}
            <section className="relative bg-gradient-to-r from-sidebar to-sidebar/90 text-sidebar-foreground py-24">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div>
                        <Button size="lg" className="text-lg px-8 py-6 rounded-full bg-primary hover:bg-primary/90 border-none">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        {data.coaches.map((coach, idx) => (
                            <div key={idx} className="group relative">
                                <div className="aspect-[4/5] rounded-2xl overflow-hidden mb-6 shadow-lg bg-muted">
                                ...
                                <p className="text-primary font-medium mb-4">{coach.title} {coach.company && `| ${coach.company}`}</p>
            ...
            <section className="py-24 bg-muted">
                <div className="container mx-auto px-6 max-w-4xl">
                    ...
                    <div className="prose lg:prose-lg text-muted-foreground mb-12">
                        ...
                        {workshop.learningOutcomes.length > 0 ? (
                            workshop.learningOutcomes.map((item, i) => (
                                <li key={i} className="flex gap-4 items-start">
                                    <div className="w-6 h-6 mt-1 rounded-full bg-primary/10 text-primary flex items-center justify-center text-sm font-bold shrink-0">
                                        ✓
                                    </div>
                            ...
                            [1, 2, 3].map((i) => (
                                <li key={i} className="flex gap-4 items-start opacity-50">
                                    <div className="w-6 h-6 mt-1 rounded-full bg-muted shrink-0" />
