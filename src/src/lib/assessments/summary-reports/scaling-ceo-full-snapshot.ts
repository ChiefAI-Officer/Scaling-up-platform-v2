...
type ValidDestinationCampaignRow = DestinationCampaignRow & {
  organizationId: string;
  organization: NonNullable<DestinationCampaignRow["organization"]>;
};
...
function sourceStateErrors(
  ...
  destination: ValidDestinationCampaignRow,
): SnapshotValidationError[] {
...
): destination is ValidDestinationCampaignRow {
  return Boolean(
    destination &&
