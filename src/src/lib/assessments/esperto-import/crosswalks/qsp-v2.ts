 ...
 *
 * ─────────────────────────────────────────────────────────────────────────
 * CROSSWALK LOCK CHECKLIST — locked stays FALSE until each of the 8 ambiguous
 * orderings is confirmed against the QSP seed screenshots (image9-22).
 * ─────────────────────────────────────────────────────────────────────────
 ...
 *     [ ] Q3_1 → P1_rate_success_rocks   (CONFIRM image12 row 1)   UNCONFIRMED
 *     [ ] Q3_2 → P1_rate_leadership_team (CONFIRM image12 row 2)   UNCONFIRMED
 *     [ ] Q3_3 → P1_rate_core_values     (CONFIRM image12 row 3)   UNCONFIRMED
 *     [ ] Q3_4 → P1_rate_atmosphere      (CONFIRM image12 row 4)   UNCONFIRMED
 *     [ ] Q3_6 → P1_rate_pride           (CONFIRM image12 row 5;   UNCONFIRMED
 *             note Q3_5 is the dropped 6th slot — see droppedKeys)
 *   START / STOP / CONTINUE triplet (image15/16/17):
 *     [ ] Q6 → P1_company_start          (CONFIRM image15)         UNCONFIRMED
 *     [ ] Q7 → P1_company_stop           (CONFIRM image16)         UNCONFIRMED
 *     [ ] Q8 → P1_company_continue       (CONFIRM image17)         UNCONFIRMED
 *   P4 pair (image20):
 *     [ ] Q14 → P4_critical_number       (CONFIRM image20 field 1) UNCONFIRMED
 *     [ ] Q15 → P4_top_priorities        (CONFIRM image20 field 2) UNCONFIRMED
 *
