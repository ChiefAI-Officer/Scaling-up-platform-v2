...
export type AuditAction = 'CREATE' | 'UPDATE' | 'DELETE' | 'APPROVE' | 'DENY' | 'LOGIN' | 'LOGOUT' | 'RESET_TO_PENDING' | 'INFO_REQUESTED' | 'COACH_RESPONSE' | 'COUNTER_OFFER' | 'ACCEPT_COUNTER' | 'DECLINE_COUNTER' | 'CLOSE' | 'EXPORT' | 'ASSESSMENT_VERSION_SEEDED' | 'GROUP_REPORT_VIEW' | 'VIEW_REPORT' | 'RESPONDENT_LONGITUDINAL_VIEW' | 'TEMPLATE_RESULTS_DEFAULT_CHANGED' | 'TEMPLATE_DISABLED' | 'TEMPLATE_ENABLED' | 'ADMIN_USER_REMOVED' | 'BENCHMARKS_RECONCILED' | 'TEMPLATE_VERSION_ARCHIVED' | 'TEMPLATE_VERSION_UNARCHIVED' | 'TEMPLATE_VERSION_DELETED' | 'STABLE_INVITATION_REJECTION_REPAIR_PENDING' | 'STABLE_INVITATION_REJECTION_REPAIR_RESOLVED' | 'STABLE_INVITATION_REJECTION_REPAIR_TERMINAL' | 'STABLE_INVITATION_REJECTION_REPAIR_FAILED_ATTEMPT';
