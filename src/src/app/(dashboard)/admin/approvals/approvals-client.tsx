...
export default function ApprovalsPage({ responsiveEnabled = false }: { responsiveEnabled?: boolean }) {
  ...
  return (
    ...
    >
      <h2 className={responsiveEnabled ? "mb-6 min-w-0 break-words text-2xl font-bold text-foreground" : "mb-6 text-2xl font-bold text-foreground"}>Approval Queue</h2>
      ...
      {counterOfferModalId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-xl bg-card p-6 shadow-xl border border-border mx-4">
            ...
            />
            <div className={responsiveEnabled ? "mt-4 flex flex-col gap-3 sm:flex-row sm:justify-end" : "flex gap-3 mt-4 justify-end"}>
              <button
                className={responsiveEnabled ? "min-h-11 px-4 py-2 rounded-md text-sm font-medium border border-border text-foreground hover:bg-accent" : "px-4 py-2 rounded-md text-sm font-medium border border-border text-foreground hover:bg-accent"}
                onClick={() => { setCounterOfferModalId(null); setCounterOfferAmount(""); setCounterOfferNoteInput(""); }}
              >
                Cancel
              </button>
              <button
                className={responsiveEnabled ? "min-h-11 px-4 py-2 rounded-md text-sm font-medium bg-warning text-white hover:bg-warning/90 disabled:opacity-50" : "px-4 py-2 rounded-md text-sm font-medium bg-warning text-white hover:bg-warning/90 disabled:opacity-50"}
