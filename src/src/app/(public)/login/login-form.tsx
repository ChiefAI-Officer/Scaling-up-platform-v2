...
export function LoginForm({ memberPortalEnabled = false }: { memberPortalEnabled?: boolean }) {
        ...
        <CardContent>
          ...
          {memberPortalEnabled && (
            <div className="mt-6 border-t border-border pt-6 text-center">
              <h2 className="text-base font-semibold text-foreground">Taken an assessment?</h2>
              <p className="mt-1 text-sm text-muted-foreground">
                We&apos;ll email you a link to your reports. No password needed.
              </p>
              <Link
                href="/member/sign-in"
                className="mt-3 inline-flex min-h-11 items-center justify-center font-medium text-primary hover:text-primary/80"
              >
                Get a link to my reports →
              </Link>
            </div>
          )}
        </CardContent>
