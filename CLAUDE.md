...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-03 LAST_UPDATED_SLUG:embeddable-workshop-images --> September 3 — **Workshop image uploads now have dedicated public Blob storage and expose image-only URLs for safe custom-HTML embedding; documents remain on authenticated download paths.** |
