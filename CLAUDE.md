...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-31 LAST_UPDATED_SLUG:gh-224-truthful-welcome-sharing-copy-launched --> July 31, 2026 — **GH #224 truthful Welcome sharing copy is MERGED + LIVE.** PR #278 replaced the unconditional confidentiality/lock claim with exact invited and public sharing disclosures, and production deployment `dpl_51NbhFeR1oPKdFXXo9K4dhRx88Gj` is healthy on merge SHA `e66c85ee`. A read-only public Quick Assessment smoke confirmed the new disclosure and absence of the old claim. Issue #224 is closed and its claim is released. Full detail in CHANGELOG entry `gh-224-truthful-welcome-sharing-copy-launched`. |
