...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-14 LAST_UPDATED_SLUG:su-full-peer-benchmark-refresh-batched --> August 14, 2026 — **The Scaling Up Full benchmark store is live and populated.** The hardened audited refresh placed all 61 controlled-test Peer values in Production, and an independent read-back found no missing, unexpected, or mismatched values. |
