...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-18 LAST_UPDATED_SLUG:su-full-esperto-landscape-dark-verified --> August 18, 2026 — **The Esperto-faithful 26-page Scaling Up Full landscape report is implemented and locally verified behind its dedicated default-OFF layout flag.** The feature release remains dark; Production activation and end-user smoke testing are separate release work. |
