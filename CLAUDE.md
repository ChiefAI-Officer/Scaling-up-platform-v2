...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-12 LAST_UPDATED_SLUG:qsp-coach-forward-invitation-copy-aligned --> August 12, 2026 — **QSP v1 and v2 coach-forward invitation defaults are IMPLEMENTED + LOCALLY VERIFIED; not deployed or written to Production.** Both seed builders now use the approved shared body while `{{templateName}}` preserves each version. Four focused seed suites pass 95/95 tests. |
