...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-31 LAST_UPDATED_SLUG:gh-242-retired-edition-warning-pr-ready --> July 31, 2026 — **GH #242 is IMPLEMENTED + LOCALLY VERIFIED, not merged or launched.** It adds a destructive detail-screen warning when a campaign's pinned edition is retired. The read-only, flagless change is currently preventive: the production audit found zero natural records in that state. Full detail in CHANGELOG entry `gh-242-retired-edition-warning-pr-ready`. |
...
| **Latest progress** | Jeff #83 **public-quiz result visibility is Complete and LAUNCHED**. PR #245 provides Coach Referred Results; PR #266 adds report email identity, verified next-step actions, and filtered CSV export; PR #250 supplies the already-live duplicate-delivery protection. The existing Referred Results production flag was already enabled, so #266 required no undark or environment change. |
...
- **GH #242 retired pinned-edition warning:** **IMPLEMENTED + LOCALLY VERIFIED; PR-ready, not merged or launched.** The read-only, flagless campaign-detail warning is preventive because the production audit found zero natural retired-pinned records. Full detail: [`gh-242-retired-edition-warning-pr-ready`](plans/CHANGELOG.md#gh-242-retired-edition-warning-pr-ready).
