...
- **Jeff #83 Referred Results:** implemented on PR #245, default-OFF pending reviewed dark deployment and launch gates. Full detail: `plans/CHANGELOG.md` entry `jeff-83-referred-results-implemented-dark`.
