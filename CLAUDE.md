...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-21 LAST_UPDATED_SLUG:member-portal-release-one-implemented --> September 21 — **Member portal Release 1 is implemented and verified behind a default-off global flag: roster-based passwordless sign-in, isolated sessions, and own-report access. It is not deployed or enabled; hierarchy remains approval-gated Release 2.** |
