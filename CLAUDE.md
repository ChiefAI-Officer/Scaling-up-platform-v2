...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-11 LAST_UPDATED_SLUG:default-report-coach-cta-removed --> September 11 — **Default assessment reports now retain Learn More while omitting the generic Talk to a Coach action across screen, print, adaptive styles, and email.** |
