...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-31 LAST_UPDATED_SLUG:gh-217-legacy-invite-fallback-pr-ready --> July 31, 2026 — **GH #217 legacy invitation fallback hardening is IMPLEMENTED + LOCALLY VERIFIED; not yet merged or live.** The dormant fallback now carries Coach identity, sends a plain-text twin, and exposes an escaped copy/paste URL while preserving the live branded renderer and delivery contracts. Production still leaves `ASSESSMENT_INVITE_BRANDED` unset; no flag or environment state was changed. Full detail in CHANGELOG entry `gh-217-legacy-invite-fallback-pr-ready`. |
...
| **Latest progress** | GH #224 **truthful Welcome sharing copy is Complete and LAUNCHED** from PR #278. Invited and public Welcome screens now describe actual review access instead of promising confidentiality. This is the fourth reportable product outcome after the sent July 27–31 report, following GH #222, GH #242, and GH #243. |
