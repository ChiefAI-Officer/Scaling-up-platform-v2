...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-17 LAST_UPDATED_SLUG:su-full-individual-peer-comparison-activation-ready --> August 17, 2026 — **SU Full paired You/Peers activation is release-ready after a read-only 61/61 Production-row verification.** The separate alias change is pending protected-branch review; Production remains dark until that merge and the existing capability flag is enabled. |
