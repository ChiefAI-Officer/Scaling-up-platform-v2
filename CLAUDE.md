...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-13 LAST_UPDATED_SLUG:template-delete-soft-deleted-campaign-guard-fixed --> August 13, 2026 — **Template deletion now ignores soft-deleted campaign tombstones while preserving their history.** Live draft and active campaigns still block deletion; implementation is verified locally and awaits merge/deployment. |
