...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-15 LAST_UPDATED_SLUG:published-report-html-parity-implemented --> September 15 — **Published report HTML/CSS now follows the Active version across every individual report screen while questions, scoring, answers, and results remain campaign-pinned; PR #446 is merged and the generic rollout is enabled on Production.** |
