...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-18 LAST_UPDATED_SLUG:su-full-esperto-landscape-dark-verified --> August 18 — **SU Full landscape verified, default-OFF, unmerged. CTA launched; successor drafts unpublished.** |
...
- **SU Full landscape:** **IMPLEMENTED + FULL-LABEL/BROWSER/PDF VERIFIED + DEFAULT-OFF; UNMERGED.** Print contours remain exact; mobile exposes truth-scaled peer bars without clipping/overflow; standalone reports have one main. Evidence: `plans/CHANGELOG.md#su-full-esperto-landscape-dark-verified`.
