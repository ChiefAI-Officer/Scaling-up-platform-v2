...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-12 LAST_UPDATED_SLUG:qsp-coach-forward-invitation-copy-production --> August 12, 2026 — **QSP v1 and v2 coach-forward invitation copy is LIVE ON PRODUCTION; received-email acceptance remains pending.** PR #337 squash-merged as `c088ded4`; Ready deployment `dpl_DZNdtLNQKn9c437zs2tfxg7uyqJM` owns both healthy canonical aliases. QSP v1 active v4 and QSP v2 active v3 expose the exact approved body. |
