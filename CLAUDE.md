...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-10 LAST_UPDATED_SLUG:public-campaigns-simple-ui-launched --> August 10, 2026 — **The simplified Public Campaigns UI is LAUNCHED + PRODUCTION-ENABLED + BROWSER-ACCEPTED.** PR #323 is live with the Production-only enable flag set, the kill flag absent, and desktop/narrow acceptance plus kill-switch rollback verified without submitting creation or Publish. Full detail in CHANGELOG entry `public-campaigns-simple-ui-launched`. |
