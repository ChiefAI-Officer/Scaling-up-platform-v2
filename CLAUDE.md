...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-06 LAST_UPDATED_SLUG:report-style-canary-launched --> August 6, 2026 — **Scaling Up Full individual report styles are deployed dark and production-verified for one disposable exact-campaign canary.** The picker correction is live; Executive Boardroom selection, save, reload, and persisted campaign override passed while the global gate remains off. Full detail in CHANGELOG entry `report-style-canary-launched`. |
