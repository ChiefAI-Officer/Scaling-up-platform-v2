...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-21 LAST_UPDATED_SLUG:member-portal-release-three-implemented --> September 21 — **Member portal Releases 1–3 are implemented and verified behind default-off gates. Members see only their open invitations and explicitly enter the canonical invited flow without credential rotation. Not merged, deployed, or enabled.** |
