...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-17 LAST_UPDATED_SLUG:admin-coach-password-actions-launched --> August 17, 2026 — **Admin coach-password actions are launched and globally enabled.** ADMIN can set a coach password with immediate session revocation; ADMIN/STAFF can send a separate 15-minute reset link. |
