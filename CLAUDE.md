...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-17 LAST_UPDATED_SLUG:referred-results-template-name-sync --> August 17, 2026 — **Referred Results now follows the current assessment-template name.** Coach public-link labels no longer retain a stale campaign name after an assessment is renamed. |
