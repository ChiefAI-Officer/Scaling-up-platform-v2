...
- **Public Assessments Coach removal:** **PR #399 OPEN.** Eligible referring Coaches can soft-remove their submissions from Coach views; ADMIN/STAFF oversight and underlying data remain. [Receipt](plans/CHANGELOG.md#referred-results-coach-removal-implemented).
