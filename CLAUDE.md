...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-02 LAST_UPDATED_SLUG:sunhub-successor-durable-verifier --> September 2 — **All-Public Welcome authority and the SunHub v7 successor are live; completion verification now tolerates workflow-owned timestamps while retaining strict identity, receipt, field, and zero-relation checks.** |
