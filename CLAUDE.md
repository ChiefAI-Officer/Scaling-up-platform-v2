...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-10 LAST_UPDATED_SLUG:public-campaign-report-design-removed-launched --> August 10, 2026 — **Public Campaign report-design controls are removed and Production-accepted.** PR #325 is live on the Ready Production deployment; authenticated Preview and Production checks confirmed the simplified list and creation screens while preserving their core controls. Full detail in CHANGELOG entry `public-campaign-report-design-removed-launched`. |
