...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-15 LAST_UPDATED_SLUG:public-campaign-lifecycle-actions --> September 15 — **Public Campaigns now have flag-gated terminal Close and soft Delete actions, with a dedicated closure timestamp, server-enforced Close-before-Delete safety, and accessible list feedback.** |
