...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-22 LAST_UPDATED_SLUG:member-portal-release-four-implemented --> September 22 — **Releases 1–4 verified behind default-off gates; Release 4 adds authenticated Coach sends and discovery. Nothing merged, deployed, enabled, or sent.** |
...
│   │   └── api/               # APIs incl. Campaign Member-link sends
│   ├── components/
