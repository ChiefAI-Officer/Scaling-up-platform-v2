...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-31 LAST_UPDATED_SLUG:gh-224-truthful-welcome-sharing-copy-pr-ready --> July 31, 2026 — **GH #224 truthful Welcome sharing copy is IMPLEMENTED + LOCALLY VERIFIED, not yet merged or launched.** Invited and public assessment Welcome screens now replace the unconditional confidentiality claim and lock icon with exact, flow-specific sharing disclosures. The default invited lede no longer claims confidentiality, and fine print no longer duplicates the disclosure. No aggregation-mode plumbing, API, schema, authorization, report, or feature-flag change was added. Full detail in CHANGELOG entry `gh-224-truthful-welcome-sharing-copy-pr-ready`. |
