...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-11 LAST_UPDATED_SLUG:report-html-author-css --> September 11 — **Welcome and Closing report authors can now enter the HTML and scoped CSS that renders, with no hidden Scaling Up Profits presentation.** |
