...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-13 LAST_UPDATED_SLUG:template-delete-soft-deleted-campaign-guard-launched --> August 13, 2026 — **The template-delete tombstone fix is LIVE ON PRODUCTION.** Soft-deleted campaigns no longer block template deletion, their history remains preserved, and live draft/active campaigns still block. |
