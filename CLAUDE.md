...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-23 LAST_UPDATED_SLUG:member-sign-in-email-dispatch-fixed --> September 23 — **Member sign-in delivery now awaits post-response SMTP; production receipt remains pending.** |
