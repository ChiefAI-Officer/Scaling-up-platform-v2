...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-30 LAST_UPDATED_SLUG:issue-238-public-quiz-print-download-launched --> July 30, 2026 — **Issue #238 public-quiz report Print and Download PDF launched.** PR #255 reused the existing report controls on the one-time public result, the exact merged deployment reached Ready, and both production aliases are healthy. Full detail in CHANGELOG entry `issue-238-public-quiz-print-download-launched`. |
