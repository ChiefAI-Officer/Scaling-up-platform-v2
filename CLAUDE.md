...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-17 LAST_UPDATED_SLUG:public-marketing-results-cta-launched --> August 17, 2026 — **Public Marketing Results CTA is LAUNCHED.** PR #365, Ready deployment `dpl_Gnex8KtE4CPckhaRbtX9qkPAahqi`, and its Production flag are live; unpublished Quick v2 and SunHub v3 drafts await ADMIN/STAFF review, with existing campaigns unchanged. |
