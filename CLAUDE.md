...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-30 LAST_UPDATED_SLUG:summary-reports-coach-dropdown-implemented --> August 30 — **Summary Reports coach-only dropdown implemented locally; PR and canary-clear merge gate pending.** |
...
- **Summary Reporting / Scaling CEO Full:** production canary verified. Handoff B1 is locally implemented: Admin drops the panel; eligible Coaches get a non-prefetching Group-report dropdown. PR/review and the GH #393 canary-clear gate remain pending; B2/B3 deliver Condensed/Comparison. [Release receipt](docs/research/evidence/summary-reporting-production-release-2026-08-27.md).
