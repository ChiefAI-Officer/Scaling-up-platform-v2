...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-30 LAST_UPDATED_SLUG:public-mini-quiz-internal-link-pre-pr --> August 30 — **The SunHub mini-quiz assessment CTA now targets Scaling Up's verified PUBLIC 32-question campaign; local verification is complete and PR review is pending, with no Production data write.** |
...
- **Summary Reporting / Scaling CEO Full:** production test-campaign canary verified, including saved PDF/access/hash checks. [Release receipt](docs/research/evidence/summary-reporting-production-release-2026-08-27.md). Global enablement awaits live PDF acceptance; six variants remain unimplemented.
