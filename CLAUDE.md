...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-17 LAST_UPDATED_SLUG:referred-results-pending-certification-guidance-ready --> August 17, 2026 — **Pending Coaches now receive actionable Referred Results guidance.** A signed-in Coach whose certification setup is still `PENDING` sees what an administrator must do and can return to My Campaigns; missing, deactivated, and expired access remains dark. |
