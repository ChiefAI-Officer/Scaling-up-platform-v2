...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-03 LAST_UPDATED_SLUG:gh-256-circle-sync-image-validation-pr-ready --> August 3, 2026 — **the narrow GH #256 Circle-sync Coach image validation slice is implemented and locally verified, but not merged.** The existing HTTPS-only policy is applied immediately before avatar persistence; host policy remains open, and GH #257 remains separately claimed. Full detail in CHANGELOG entry `gh-256-circle-sync-image-validation-pr-ready`. |
