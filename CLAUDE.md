...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-10 LAST_UPDATED_SLUG:public-campaign-report-design-removed-release-ready --> August 10, 2026 — **Public Campaign report-design controls are removed and locally release-ready.** New campaigns inherit the selected assessment default; API/schema compatibility is unchanged. Protected-PR, browser, and Production acceptance remain pending; no flag, deployment, or Production state has changed. Full detail in CHANGELOG entry `public-campaign-report-design-removed-release-ready`. |
