...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-10 LAST_UPDATED_SLUG:public-campaigns-simple-ui-release-ready --> August 10, 2026 — **The simplified Public Campaigns UI is independently review-approved and ready for protected release, still behind a default-OFF flag.** The list-first manager and dedicated creation page remove organization selection and technical jargon while preserving legacy rollback. Browser acceptance remains required before the flag is enabled. Full detail in CHANGELOG entry `public-campaigns-simple-ui-release-ready`. |
