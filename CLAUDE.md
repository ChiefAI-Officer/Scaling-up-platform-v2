...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-13 LAST_UPDATED_SLUG:customer-campaign-accordion-implemented --> August 13, 2026 — **Coach and admin campaign lists now open one customer at a time.** Customer rows start collapsed, status changes reset the accordion, and existing edition/status/metrics behavior remains intact; implementation is verified locally and awaits merge/deployment. |
