...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-02 LAST_UPDATED_SLUG:five-dysfunctions-group-report-entry-implemented --> September 2 — **Five Dysfunctions campaigns can now surface the existing coach-side group report behind an independent default-OFF flag set, with the admin and individual-report surfaces unchanged.** |
