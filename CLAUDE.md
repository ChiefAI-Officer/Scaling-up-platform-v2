...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-11 LAST_UPDATED_SLUG:universal-invitation-banner-launched --> August 11, 2026 — **The universal INVITED-email banner is LAUNCHED + GLOBALLY ENABLED + PRODUCTION-VERIFIED.** PR #331 squash-merged as `dc0026fd`; enabled deployment `dpl_H7JnKCB9eXoMoYF4cUDthxnG1sCy` is Ready on both healthy canonical aliases. The encrypted global flag is truthy; CANARY and KILL are absent. The read-only audit found zero live custom-HTML overrides. |
