...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-13 LAST_UPDATED_SLUG:customer-campaign-accordion-launched --> August 13, 2026 — **The customer-first Coach/Admin campaign accordion is LIVE ON PRODUCTION.** Customers start collapsed, one opens at a time, and status changes restore the tidy overview. |
