...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-31 LAST_UPDATED_SLUG:consolidated-progress-through-gh-243 --> July 31, 2026 — **The fresh consolidated-progress ledger is current through GH #243.** The three reportable product outcomes after the already-sent July 27–31 report are GH #222 Welcome accuracy, GH #242 retired-edition warning, and GH #243 campaign-list edition visibility. Documentation closeouts, deferrals, designs, and active unmerged work do not increase that count. GH #217 is the next primed, unclaimed-at-selection item; Jeff #65 and GH #224 already have active claims. Full boundary and selection evidence in CHANGELOG entry `consolidated-progress-through-gh-243`. |
...
| **Latest progress** | GH #243 **campaign-list edition visibility is Complete and LAUNCHED** from PR #275. Admin and Coach campaign rows now display the pinned edition and lifecycle-aware standing without changing campaign data. This is the third reportable product outcome after the sent July 27–31 report, following GH #222 and GH #242. |
...
- **GH #217 legacy invitation fallback hardening:** primed and claimed on issue #261 for branch `codex/217-legacy-invite-fallback-hardening`. Current `main` still leaves the dormant `ASSESSMENT_INVITE_BRANDED=0` renderer without threaded Coach identity, a plain-text twin, or a bottom fallback URL. Design/verification comes first; no implementation or production flag change is represented by this SoT update.
