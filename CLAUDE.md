...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-17 LAST_UPDATED_SLUG:su-full-individual-peer-comparison-dark-verified --> August 17, 2026 — **SU Full paired You/Peers UI is locally verified, dark, and not deployed.** Its alias is absent from `PEER_RENDER_ENABLED_ALIASES`, so runtime reports remain unchanged. |
