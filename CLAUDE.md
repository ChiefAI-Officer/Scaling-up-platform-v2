...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-30 LAST_UPDATED_SLUG:scaling-condensed-ceo-html-implemented --> August 30 — **Scaling Condensed CEO is locally implemented as canonical two-page HTML; not deployed.** |
...
- **Summary Reporting / Scaling CEO Full + Condensed:** PR #397 is merge-authorized. B2 locally adds a one-click, two-page HTML report sourced only from the campaign CEO; it is not merged or deployed. Comparison remains B3. [Release receipt](docs/research/evidence/summary-reporting-production-release-2026-08-27.md).
