...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-10 LAST_UPDATED_SLUG:public-campaigns-simple-ui-built --> August 10, 2026 — **The simplified Public Campaigns UI is built behind a default-OFF flag and is not Production-enabled yet.** The approved list-first manager and dedicated creation page use plain language while preserving organization-free creation and existing management behavior. Full detail in CHANGELOG entry `public-campaigns-simple-ui-built`. |
