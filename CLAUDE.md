...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-02 LAST_UPDATED_SLUG:public-result-summary-deduplication --> September 2 — **Public on-screen assessment results now avoid a redundant overall-score card when the versioned marketing score guide is present, while print/PDF and no-band fallbacks retain the canonical result.** |
