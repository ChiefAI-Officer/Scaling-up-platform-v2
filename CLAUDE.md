...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-09-14 LAST_UPDATED_SLUG:admin-alert-live-staff-fanout --> September 14 — **Admin-facing approval, workshop, registration, pricing, and completion alerts now fan out as separate emails to every live human ADMIN/STAFF account, with delivery telemetry and safe fallback routing.** |
