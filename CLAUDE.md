...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-08-08 LAST_UPDATED_SLUG:jul10-84-sunhub-build-ready --> August 8, 2026 — **July 10 row #84 has a source-backed separate SunHub quick-quiz build ready for protected review, not Production activation.** The tracked SunHub workbook now locks the eight questions, scoring bands, feedback, and CTAs. The existing 32-question `scaling-up-quick` assessment remains unchanged. Full detail in CHANGELOG entry `jul10-84-sunhub-build-ready`. |
...
| **Latest progress** | The [July 10 canonical closeout ledger](docs/agents/jul10-feedback-closeout.md) now records 44 DONE, 4 PARTIAL, and 5 NEEDS DECISION. #84 moves from decision to acceptance: its source-backed separate-template build is ready for protected review, while Production DRAFT creation, publication, campaign creation, submission, and live screen/email verification remain separately authorized gates. The tracked [August 1–7 consolidated delta](docs/agents/jul10-progress-delta-2026-08-01-to-2026-08-07.md) remains exactly 12 eligible outcomes because #84 work began on August 8. No Production state was changed. |
...
- **Jeff July-10 assessment-feedback closeout:** the tracked [53-row canonical ledger](docs/agents/jul10-feedback-closeout.md) is authoritative at **44 DONE / 4 PARTIAL / 5 NEEDS DECISION**. #84 is no longer decision-blocked: the tracked SunHub source supports a separate eight-question build, but protected merge and separately authorized Production activation/live verification remain before closure. Exact Section 2 wording is the acceptance boundary; generated PDFs and `tmp/` dictionaries remain derivatives.
