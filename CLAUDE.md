...
| **Last Updated** | <!-- LAST_UPDATED_ISO:2026-07-31 LAST_UPDATED_SLUG:gh-242-retired-edition-warning-launched --> July 31, 2026 — **GH #242 is MERGED + LIVE.** PR #273 shipped the destructive campaign-detail warning for retired pinned editions as squash `54d0c215`; the exact production deployment is Ready and healthy. The read-only, flagless change remains preventive because production has zero natural retired-pin records. Full detail in CHANGELOG entry `gh-242-retired-edition-warning-launched`. |
