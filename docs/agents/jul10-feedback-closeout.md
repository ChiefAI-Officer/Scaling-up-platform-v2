...
| #42 | LVA Growth Financing wording | Clarify that the factor means access or ability to obtain financing for growth. | PARTIAL | [Approved implementation](jul10-feedback-decision-packets.md#42-lva-growth-financing-wording) | PR #304 | Merge the seed change, then separately authorize creation and visual verification of a new draft; publishing and live verification remain separate. | Gabriel |
