...
- [ ] **Step 1: Write the failing normalization/authority tests**
...
Expected: baseline-equal cases omit `welcomeConfig` under the old resolver.

- [ ] **Step 3: Remove alias selection from the call site**
...
- [ ] **Step 4: Run the page suite and resolver suite and verify GREEN**
...
- [ ] **Step 1: Verify the renderer acceptance seam**
...
- [ ] **Step 2: Run Public renderer and INVITED regression suites**
...
- [ ] **Step 1: Amend only ADR-0033's PUBLIC clause**
...
- [ ] **Step 2: Mark Option C superseded and update glossary/SoT**
...
- [ ] **Step 3: Review the fixed-point diff**
