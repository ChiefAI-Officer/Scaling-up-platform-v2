...
**Tests:** 124 new in the feature PR (serialization 48, flag 13, route 22, unions 5, E2E pipeline 6 — editor payload → publish schema → survey pages → report model, questions-tab 23, tabbed 6 incl. two adversarial-review regression proofs) + 3 in #136; targeted sweep 338/338; `CI=true npx next build --turbopack` green. **Kill = zero the flag + redeploy** (drafts already saved stay valid and publishable).
